...
//	Insert Patient
	...
	public String insertPatient(@FormParam("type") String type,
		...
		String output = patientService.insertPatient(type, email, password, contactNo, firstName, lastName, DOB, age, sex, NIC, address);
		return output;
	}
...
//			Retrieve  single doctor
			...
			@Path("/{id}")
			@Produces(MediaType.TEXT_PLAIN)
			public String getPatientDetails(@PathParam("id") String id) {
				Patient patient = patientService.getPatientDetails(id);
				return patient + "";
			}
